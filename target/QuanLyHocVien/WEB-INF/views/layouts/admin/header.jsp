...
<div id="header" class="mdk-header js-mdk-header mb-0" data-fixed>
    <div class="mdk-header__content">
        <div
                class="navbar navbar-expand pr-0 navbar-light bg-white navbar-shadow"
                id="default-navbar"
                data-primary
        >
            <!-- Navbar toggler -->
                        ...
                        <span class="d-flex align-items-center mb-1">
                          ...
                          <span class="avatar avatar-xs mr-2">
                            <span class="avatar-title rounded-circle bg-light">
                              <i
                                      class="material-icons font-size-16pt text-accent"
                              >account_circle</i
                              >
                            </span>
                          </span>
                ...
                <div class="nav-item dropdown">
                  ...
                  <span class="avatar avatar-sm mr-8pt2">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="sticky-edit-account.html"
                        >Edit Account</a
                        >
                        <a class="dropdown-item" href="sticky-billing.html"
                        >Billing</a
                        >
                        <a class="dropdown-item" href="sticky-billing-history.html"
                        >Payments</a
                        >

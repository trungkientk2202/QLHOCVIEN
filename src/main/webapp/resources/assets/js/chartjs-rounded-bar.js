!function (t) {
    ...
    0: function (t, n, r) {
        var e = r(18)("wks"), o = r(14), i = r(1).Symbol, u = "function" == typeof i;
        ...
        var e = r(1), o = r(9), i = r(6), u = r(8), c = r(19), f = function (t, n, r) {
            var a, l, s, p, d = t & f.F, h = t & f.G, v = t & f.S, y = t & f.P, b = t & f.B,
                x = h ? e : v ? e[n] || (e[n] = {}) : (e[n] || {}).prototype, g = h ? o : o[n] || (o[n] = {}),
        ...
        var e = r(9), o = r(1), i = o["__core-js_shared__"] || (o["__core-js_shared__"] = {});
        (t.exports = function (t, n) {
        ...
        var e = r(3), o = r(1).document, i = e(o) && e(o.createElement);
        t.exports = function (t) {
        ...
        var e = r(0)("unscopables"), o = Array.prototype;
        ...
        Chart.elements.RoundedTopRectangle = Chart.elements.Rectangle.extend({
            draw: function () {
                var t, n, r, e, o, i, u, c = this._chart.ctx, f = this._view, a = f.borderWidth;
                if (f.horizontal ? (t = f.base, n = f.x, r = f.y - f.height / 2, e = f.y + f.height / 2, o = n > t ? 1 : -1, i = 1, u = f.borderSkipped || "left") : (t = f.x - f.width / 2, n = f.x + f.width / 2, r = f.y, o = 1, i = (e = f.base) > r ? 1 : -1, u = f.borderSkipped || "bottom"), a) {
                    var l = Math.min(Math.abs(t - n), Math.abs(r - e)), s = (a = a > l ? l : a) / 2,
                        p = t + ("left" !== u ? s * o : 0), d = n + ("right" !== u ? -s * o : 0),
                        h = r + ("top" !== u ? s * i : 0), v = e + ("bottom" !== u ? -s * i : 0);
                    p !== d && (r = h, e = v), h !== v && (t = p, n = d)
                }
                var y = Math.abs(t - n), b = r,
                    x = (r = b + y * (this._chart.config.options.barRoundness || .5) * .5) - b;
                c.beginPath(), c.fillStyle = f.backgroundColor, c.strokeStyle = f.borderColor, c.lineWidth = a, function (t, n, r, e, o, i) {
        ...
        var e = r(17), o = Math.max, i = Math.min;
        t.exports = function (t, n) {
        ...
        var e = r(4), o = r(29), i = r(22), u = Object.defineProperty;
        ...
        var e = r(1), o = r(6), i = r(11), u = r(14)("src"), c = r(36), f = ("" + c).split("toString");

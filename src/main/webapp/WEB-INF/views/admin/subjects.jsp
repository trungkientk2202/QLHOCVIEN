        ...
        <div class="mdk-drawer-layout__content page-content mt-5">
            <div class="pt-32pt">
                <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                    ...
                    <div class="row" role="tablist">
                        <div class="col-auto">
                            <a href="/admin/subject/add" class="btn btn-outline-secondary"><span
                                    class="icon--left material-icons icon-16pt">add</span> New Subject</a>
                        </div>
                    </div>
            ...
            <div class="container page__container page-section">
                <div class="page-separator">
                    <div class="page-separator__text">All Subject</div>
                </div>
